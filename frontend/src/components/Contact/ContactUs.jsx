    ...
    <div className="flex flex-col md:flex-row items-center justify-center my-10">
      <div className="flex-1 max-w-md mx-auto mb-10 md:mb-0">
        ...
        <img
          src="/contact-us.png"
          alt="Contact Us"
          className="object-cover animate-hover"
        />
      </div>
      ...
      <div className="flex-1 max-w-md mx-auto bg-white p-8 shadow-lg rounded">
        <div className="contact-form space-y-4">
          <div>
            <label htmlFor="user_name" className="text-gray-600">
              Name
            </label>
            <input
              type="text"
          ...
          <input
            ...
            value="Send"
            onClick={sendEmail}
            className="mt-4 px-4 py-2 bg-indigo-600 text-white font-bold rounded hover:bg-indigo-700 cursor-pointer block w-full"
          />
        </div>
      </div>
    </div>
